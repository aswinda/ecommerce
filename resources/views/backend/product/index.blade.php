                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/product/show/'.$product->product_id) }}">
                          {{ $product->name }} 
                        </a>
                      </td>
                      <td>
                        ...
                        <td>
                           <?php if($product->is_featured) echo 'Yes'; else echo 'No'; ?>
                          
                        </td>
                        <td class="text-center">

                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/product/delete/'.$product->product_id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/product/edit/'.$product->product_id) }}">
